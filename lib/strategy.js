 ...
 *   - `authorizationURL` URL for authorization redirects (if cannot be infered from authServerURL).
 *   - `tokenURL`         URL for token validation (if cannot be infered from authServerURL).
 *   - `userProfileURL`   URL for userProfile retrieve (if cannot be infered from authServerURL).
...
function Strategy(options, verify) {
  ...
  options.authorizationURL = options.authorizationURL || `${options.authServerURL}/realms/${options.realm}/protocol/openid-connect/auth`;
  options.tokenURL = options.tokenURL || `${options.authServerURL}/realms/${options.realm}/protocol/openid-connect/token`;
  ...
  this.name = 'keycloak';
  this._userProfileURL = options.userProfileURL || `${options.authServerURL}/realms/${options.realm}/protocol/openid-connect/userinfo`;
}
